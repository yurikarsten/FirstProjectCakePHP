...
--
-- Máquina: localhost
-- Data de Criação: 23-Jul-2013 às 22:28
...
CREATE TABLE IF NOT EXISTS `addresses` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_Cidades_enderecos_idx` (`city_id`)
...
CREATE TABLE IF NOT EXISTS `people` (
  ...
  `corporateName` varchar(120) DEFAULT NULL,
  ...
  `skypeMsg` varchar(25) DEFAULT NULL,
  `gtalkMsg` varchar(25) DEFAULT NULL,
  `otherMsg` varchar(25) DEFAULT NULL,
  `obs` text,
  PRIMARY KEY (`id`),
  UNIQUE KEY `cnpj_UNIQUE` (`cnpj`),
  UNIQUE KEY `cpf_UNIQUE` (`cpf`),
  KEY `fk_Enderecos_pessoas_idx` (`address_id`),
  KEY `fk_Usuario_pessoas_idx` (`user_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
CREATE TABLE IF NOT EXISTS `states` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_Estados_paises_idx` (`country_id`)
...
ALTER TABLE `addresses`
  ADD CONSTRAINT `fk_Cidades_enderecos` FOREIGN KEY (`city_id`) REFERENCES `cities` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `cities`
--
ALTER TABLE `cities`
  ADD CONSTRAINT `fk_Cidades_estados` FOREIGN KEY (`state_id`) REFERENCES `states` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `people`
--
ALTER TABLE `people`
  ADD CONSTRAINT `fk_Enderecos_pessoas` FOREIGN KEY (`address_id`) REFERENCES `addresses` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `fk_Usuario_pessoas` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;

--
-- Limitadores para a tabela `states`
--
ALTER TABLE `states`
  ADD CONSTRAINT `fk_Estados_paises` FOREIGN KEY (`country_id`) REFERENCES `countries` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
